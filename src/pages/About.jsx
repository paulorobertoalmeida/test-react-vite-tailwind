          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
              <div class="w-full md:w-2/5 h-80">
                <img class="object-center object-cover w-full h-full" src="https://media-exp1.licdn.com/dms/image/C4D03AQFLhjqnDoBMJw/profile-displayphoto-shrink_800_800/0/1614623723983?e=1660176000&v=beta&t=JzxV-xzeAJ5u-wvdqp8sotQhoKf94DK9Jr7eU6bLcZQ" alt="photo" />
              </div>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
              <div class="w-full md:w-2/5 h-80">
                <img class="object-center object-cover w-full h-full" src="https://media-exp1.licdn.com/dms/image/C4D03AQGS9D_JXTFlaQ/profile-displayphoto-shrink_800_800/0/1554386230482?e=1660176000&v=beta&t=WiLVuFOiXG-HTYB_VZbGwCDu-BtMxWLjs9nA3WhUlN4" alt="photo" />
              </div>
